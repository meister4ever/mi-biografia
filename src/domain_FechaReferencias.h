#ifndef DOMAIN_FECHAREFERENCIAS_H_INCLUDED
#define DOMAIN_FECHAREFERENCIAS_H_INCLUDED

#include "domain_RegistroGenerico.h"


class FechaReferencias : public RegistroGenerico {
    public:
        FechaReferencias(unsigned int clave);
        FechaReferencias();
        ~FechaReferencias();
...
#endif // DOMAIN_FECHAREFERENCIAS_H_INCLUDED
